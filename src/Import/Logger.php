...
/**
 * Creates, writes to and reads from the import log database table.
 */
class Logger {
	...
	/**
	 * Creates (or upgrades) the log table via dbDelta and stores the version.
	 */
	...
	public static function get_for_feed( int $feed_id, int $limit = 20 ): array {
		...
		// phpcs:disable WordPress.DB.PreparedSQL.InterpolatedNotPrepared -- $table is $wpdb->prefix . 'vev_import_log', an internal non-user value; SQL kept identical.
