...
final class VEV_Post_Type {
        ...
        private static function register_post_type(): void {
                ...
                $labels = array(
                        'name'                  => _x( 'Events', 'post type general name', VEV_Events::TEXTDOMAIN ),
                        'singular_name'         => _x( 'Event', 'post type singular name', VEV_Events::TEXTDOMAIN ),
                        'add_new'               => _x( 'Add New', 'event', VEV_Events::TEXTDOMAIN ),
                        ...
                        'menu_name'             => _x( 'Events', 'admin menu', VEV_Events::TEXTDOMAIN ),
                );
                ...
                $args = array(
                        ...
                        'show_in_menu'       => true,
                        'query_var'          => true,
                        'rewrite'            => array( 'slug' => $slug_single, 'with_front' => false ),
